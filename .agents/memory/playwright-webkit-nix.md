...
**How to apply:** Keep WebKit as an explicit release gate. If the host cannot launch it, report the missing runtime dependency and repair the runner image or system package set rather than adding an automatic pass-through.