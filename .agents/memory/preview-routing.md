...
**How to apply:** Inspect registered artifacts and artifact service logs before changing application code; verify both the managed artifact screenshot and the public development URL.