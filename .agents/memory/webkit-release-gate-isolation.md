...
**How to apply:** Read the per-test Playwright error context first. Use the targeted nutrition results to validate meal replacement behavior, and track unrelated coach/realtime failures separately.