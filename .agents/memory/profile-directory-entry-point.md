---
name: Profile directory entry point
description: Navigation decision for coach and owner trainee profile access
---

The home-screen `פרופילים` directory is the canonical entry point for opening a trainee’s full profile. The profile view should contain personal details, messaging, check-in, activity history, and measurements. Do not duplicate the entry point with a `פרופיל` button in the selected trainee’s Programs or Tracking workspace header.
