...
Call log:
  - waiting for getByRole('button', { name: 'החלפה', exact: true }).first()
    - waiting for "http://127.0.0.1:4173/nutrition" navigation to finish...
    - navigated to "http://127.0.0.1:4173/nutrition"
...
- generic [ref=f1e2]:
  - banner [ref=f1e3]:
    - generic [ref=f1e4]:
      ...
      - generic [ref=f1e11]:
        - generic [ref=f1e12]:
          - paragraph [ref=f1e13]: בניית תוכניות ותפריטים
          - heading "עריכה" [level=1] [ref=f1e14]
        - button "נמצאה התנגשות — נדרשת בחירה לפני סנכרון" [ref=f1e16]
  - main [ref=f1e19]:
    - generic [ref=f1e20]: נמצאה התנגשות — נדרשת בחירה לפני סנכרון
    - generic [ref=f1e24]:
      - generic [ref=f1e25]:
        - heading "מתאמנת בדיקה" [level=3] [ref=f1e26]
        - generic [ref=f1e28]:
          - button "פתיחת פרופיל המשתמש" [ref=f1e29]: פרופיל
          - button "סגירת תכנית המתאמן" [ref=f1e34]
      - navigation "ניווט בסביבת העריכה" [ref=f1e38]:
        - tab "תוכנית אימונים" [selected] [ref=f1e39]
        - tab "תפריט תזונה" [ref=f1e46]
      - generic [ref=f1e51]:
        - generic [ref=f1e53]:
          - textbox "שם תוכנית חדשה" [ref=f1e54]
          - button "צור" [ref=f1e55] [cursor=pointer]
        - generic [ref=f1e59]:
          - generic [ref=f1e60]:
            - generic [ref=f1e61]:
              - textbox "שם תוכנית האימון" [ref=f1e62]: תוכנית בדיקה לאייפון
              - generic [ref=f1e63]: 4 ימי אימון · 8 תרגילים
            - generic [ref=f1e64]:
              - button "סגירה" [ref=f1e65]
              - button "מחק את התוכנית תוכנית בדיקה לאייפון" [ref=f1e68]:
                - generic [ref=f1e72]: מחק
          - generic [ref=f1e73]:
            - button "פתיחת אתגרים" [ref=f1e75]: אתגרים
            - generic [ref=f1e82]:
              - 'textbox "שם יום אימון (למשל: A - פלג גוף עליון)..." [ref=f1e83]'
              - button "+ יום" [ref=f1e84] [cursor=pointer]
            - generic [ref=f1e85]:
              - button "בניית אימון אימון בדיקה ארוך" [ref=f1e86]:
                - generic [ref=f1e87]:
                  - generic [ref=f1e88]: אימון בדיקה ארוך
                  - generic [ref=f1e89]: 8 תרגילים
                - generic [ref=f1e90]: בניית אימון
              - button "בניית אימון אימון בדיקה 2" [ref=f1e91]:
                - generic [ref=f1e92]:
                  - generic [ref=f1e93]: אימון בדיקה 2
                  - generic [ref=f1e94]: 0 תרגילים
                - generic [ref=f1e95]: בניית אימון
              - button "בניית אימון אימון בדיקה 3" [ref=f1e96]:
                - generic [ref=f1e97]:
                  - generic [ref=f1e98]: אימון בדיקה 3
                  - generic [ref=f1e99]: 0 תרגילים
                - generic [ref=f1e100]: בניית אימון
              - button "בניית אימון אימון בדיקה 4" [ref=f1e101]:
                - generic [ref=f1e102]:
                  - generic [ref=f1e103]: אימון בדיקה 4
                  - generic [ref=f1e104]: 0 תרגילים
                - generic [ref=f1e105]: בניית אימון
  - navigation "ניווט ראשי":
    - generic [ref=f1e106]:
      - link [ref=f1e107]:
        - /url: /coach
      - link "מתאמנים" [ref=f1e111]:
        - /url: /coach/clients
      - link "מעקב" [ref=f1e118]:
        - /url: /coach/tracking
      - link "תרגילים" [ref=f1e122]:
        - /url: /exercises
```
