...
Call log:
  ...
  - waiting for locator('[data-coach-workspace="true"]')
    5 × locator resolved to <div aria-busy="true" data-coach-workspace="true" data-coach-details-state="loading" data-tsd-source="/src/routes/coach.tsx:5626:13" class="w-full  space-y-1.5 bg-background min-w-0 max-w-full overflow-x-hidden pb-10 ">…</div>
      - unexpected value "loading"
    38 × locator resolved to <div aria-busy="false" data-coach-workspace="true" data-coach-details-state="ready" data-tsd-source="/src/routes/coach.tsx:5626:13" class="w-full  space-y-1.5 bg-background min-w-0 max-w-full overflow-x-hidden pb-10 ">…</div>
