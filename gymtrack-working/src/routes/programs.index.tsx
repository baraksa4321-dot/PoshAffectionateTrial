...
const EXPANDED_PLAYLIST_STYLES = [
  ...
  },
  {
    ...
    query: "music for focus",
    className: "bg-[#eef8f5] text-[#397568] hover:bg-[#dceee9]",
  },
  {
    style: "קלאסי",
    query: "classical essentials",
          ...
          <div className="w-full max-w-sm rounded-3xl border border-border bg-surface p-4 text-start shadow-xl">
            ...
            {selectedPlaylistStyle ? (
              <>
                ...
                <p className="mb-2 text-sm font-extrabold text-ink">{selectedPlaylistStyle}</p>
