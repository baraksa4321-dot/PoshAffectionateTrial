...
const LOADING_MESSAGES = [
  ...
  "מעמיסים את האימון, לאט ובדיוק",
  "טוענים את התרגילים, בלי קיצורי דרך",
  "מסדרים את הסטים לפני שמתחילים",
  "מכינים את התוכנית למסך",
  "מסנכרנים את השגרה שלך",
  "בודקים שהכל מחכה במקום",
  "מרעננים את הנתונים, עוד רגע",
  "מכינים את האימון הבא",
] as const;
