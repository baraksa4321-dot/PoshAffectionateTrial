...
export const RECIPE_LIBRARY: RecipeDefinition[] = [
  ...
  },
  {
    ...
    category: "ארוחה קלה",
    ingredients: ["2 מלפפונים", "100 ג׳ לאבנה 5%", "שמיר ונענע", "כפית שמן זית", "לימון, מלח ופלפל"],
    instructions: [
  ...
  },
  {
    ...
    category: "מתוק מאוזן",
    ingredients: ["200 ג׳ יוגורט חלבון", "תפוח קטן חתוך", "כפית דבש", "קינמון", "10 ג׳ אגוזים קצוצים"],
    instructions: [
  ...
  },
  {
    ...
    category: "עתיר חלבון",
    ingredients: ["2 פרוסות לחם מלא", "קופסת טונה במים", "2 כפות יוגורט", "מלפפון חמוץ", "חרדל ופלפל"],
    instructions: [
  ...
  },
  {
    ...
    category: "דל שומן",
    ingredients: ["טורטייה קטנה", "120 ג׳ חזה עוף", "חסה ועגבנייה", "כף יוגורט", "פפריקה, שום ולימון"],
    instructions: [
