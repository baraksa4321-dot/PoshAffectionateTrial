...
export const ADDITIONAL_EXERCISES: Exercise[] = [
  ...
  makeExercise(
    ...
    "אירובי",
    "אחר",
    "Walk or run on a treadmill at a repeatable pace.",
    "Choose a pace you can control and reduce speed before form or breathing breaks down.",
    "אירובי",
  ),
  makeExercise(
    "ex-stair-climber",
    ...
    "אירובי",
    "אחר",
    "Climb a stair machine at a steady, controlled rhythm.",
    "Keep the torso tall and use the rails only for balance.",
    "אירובי",
  ),
  makeExercise(
    "ex-elliptical",
    ...
    "אירובי",
    "אחר",
    "Move smoothly on an elliptical trainer with a controlled stride.",
    "Keep the knees tracking forward and adjust resistance before losing rhythm.",
    "אירובי",
  ),
  makeExercise(
    "ex-stationary-bike",
    ...
    "אירובי",
    "אחר",
    "Ride a stationary bike with a steady cadence and controlled resistance.",
    "Keep the cadence smooth and stay seated during the hard efforts.",
    "אירובי",
  ),
  makeExercise(
