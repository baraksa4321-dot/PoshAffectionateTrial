...
const ISRAELI_SUPERMARKET_FOODS: FoodItem[] = [
  ...
  },
  {
    ...
    name: "עגבנייה טרייה",
    category: "ירקות",
    servingSize: "יחידה בינונית (172g)",
    calories: 31.0,
    protein: 1.5,
    carbs: 6.7,
    fat: 0.3,
  ...
  },
  {
    ...
    name: "גזר טרי",
    category: "ירקות",
    servingSize: "יחידה בינונית (136g)",
    calories: 55.8,
    protein: 1.3,
    carbs: 13.0,
    fat: 0.3,
  ...
  },
  {
    ...
    name: "פלפל ירוק",
    category: "ירקות",
    servingSize: "יחידה בינונית (166g)",
    calories: 33.2,
    protein: 1.4,
    carbs: 7.7,
    fat: 0.3,
  ...
  },
  {
    ...
    name: "פלפל צהוב",
    category: "ירקות",
    servingSize: "יחידה בינונית (122g)",
    calories: 32.9,
    protein: 1.2,
    carbs: 7.7,
    fat: 0.3,
  ...
  },
  {
    ...
    fat: 0.4,
    fiber: 1.7,
    notes: "מזון מבושל ללא תוספות; הערכים חושבו מדף FoodsDictionary ל-100 גרם.",
    nutritionReview: {
      status: "reviewed",
      origin: "verified",
      checkedAt: "2026-09-11",
      ...
      sources: [
        {
          name: "FoodsDictionary — קישוא (קיץ) מבושל",
          url: "https://www.foodsdictionary.co.il/Products/1/%D7%A7%D7%99%D7%A9%D7%95%D7%90%20%2528%D7%A7%D7%99%D7%A5%2529%20%D7%9E%D7%91%D7%95%D7%A9%D7%9C",
          kind: "food-dictionary",
          match: "same-food",
          valuesPer: "100g",
        },
      ...
      method: "official",
      notes: "20 קלוריות, 0.91 חלבון, 4.31 פחמימות, 0.31 שומן ו-1.4 סיבים ל-100 גרם; הומרו ליחידה של 120 גרם.",
    },
  },
  {
    id: "f-israel-206",
  ...
  },
  {
    ...
    name: "בצל צהוב / סגול",
    category: "ירקות",
    servingSize: "יחידה בינונית (125g)",
    calories: 50.0,
    protein: 1.4,
    carbs: 11.7,
    fat: 0.1,
...
const existingEverydayAndCommonNames = new Set([
  ...
  ...ISRAELI_PROTEIN_PRODUCTS.map((f) => f.name.trim().toLocaleLowerCase()),
]);
...
export const EVERYDAY_FOOD_DATABASE: FoodItem[] = [
  ...
  ...COMMON_FOODS.filter(
    (food) =>
      !existingEverydayNames.has(food.name.trim().toLocaleLowerCase()) &&
      !ISRAELI_PROTEIN_PRODUCTS.some(
        (proteinFood) =>
          proteinFood.name.trim().toLocaleLowerCase() === food.name.trim().toLocaleLowerCase(),
      ),
  ),
