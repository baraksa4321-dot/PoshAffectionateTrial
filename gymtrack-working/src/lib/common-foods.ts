...
export const COMMON_FOODS: FoodItem[] = [
  ...
  makeFood(
    ...
    [],
    {
      ...
      sources: [
        {
          name: "FoodsDictionary — קינואה מבושלת",
          url: "https://www.foodsdictionary.co.il/Products/1/%D7%A7%D7%99%D7%A0%D7%95%D7%90%D7%94%20%D7%9E%D7%91%D7%95%D7%A9%D7%9C%D7%AA",
          kind: "food-dictionary",
          match: "same-food",
          valuesPer: "100g",
        },
      ...
      method: "official",
      notes: "הערכים תואמים לדף קינואה מבושלת.",
    },
  ),
  ...
  makeFood("f-common-broccoli", "ברוקולי", "ירקות", "100 גרם", 34, 2.8, 6.6, 0.4, 2.6),
  makeFood("f-common-cauliflower", "כרובית", "ירקות", "100 גרם", 25, 2, 5.3, 0.1, 2.5),
  makeFood("f-common-zucchini", "קישוא", "ירקות", "100 גרם", 16, 1.2, 3.4, 0.3, 1.1),
