...
export const THEME_PALETTES: Array<{
  ...
  { id: "blue", label: "כחול", description: "כחול נקי עם גוונים בהירים ועמוקים", swatch: "#3b82b5", previewSurface: "#ffffff", previewAccent: "#bfe5f5" },
  { id: "beige", label: "בז׳", description: "בז׳ חם עם גוונים טבעיים", swatch: "#c3a47b", previewSurface: "#fffdf9", previewAccent: "#eadbc5" },
  { id: "green", label: "ירוק", description: "ירוק טבעי עם גוונים בהירים ועמוקים", swatch: "#3f8a67", previewSurface: "#ffffff", previewAccent: "#c5ead5" },
