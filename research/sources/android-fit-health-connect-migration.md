Source: https://developer.android.com/health-and-fitness/health-connect/migration/fit
Title: Fit migration guide  |  Android health & fitness  |  Android Developers
Fetched: 2026-09-02T12:59:45.327Z

[Skip to main content](https://developer.android.com/health-and-fitness/health-connect/migration/fit#main-content)
...
- [English](https://developer.android.com/health-and-fitness/health-connect/migration/fit)
- [Deutsch](https://developer.android.com/health-and-fitness/health-connect/migration/fit?hl=de)
- [Español – América Latina](https://developer.android.com/health-and-fitness/health-connect/migration/fit?hl=es-419)
- [Français](https://developer.android.com/health-and-fitness/health-connect/migration/fit?hl=fr)
- [Indonesia](https://developer.android.com/health-and-fitness/health-connect/migration/fit?hl=id)
- [Italiano](https://developer.android.com/health-and-fitness/health-connect/migration/fit?hl=it)
- [Polski](https://developer.android.com/health-and-fitness/health-connect/migration/fit?hl=pl)
- [Português – Brasil](https://developer.android.com/health-and-fitness/health-connect/migration/fit?hl=pt-br)
- [Tiếng Việt](https://developer.android.com/health-and-fitness/health-connect/migration/fit?hl=vi)
- [Türkçe](https://developer.android.com/health-and-fitness/health-connect/migration/fit?hl=tr)
- [Русский](https://developer.android.com/health-and-fitness/health-connect/migration/fit?hl=ru)
- [עברית](https://developer.android.com/health-and-fitness/health-connect/migration/fit?hl=he)
- [العربيّة](https://developer.android.com/health-and-fitness/health-connect/migration/fit?hl=ar)
- [فارسی](https://developer.android.com/health-and-fitness/health-connect/migration/fit?hl=fa)
- [हिंदी](https://developer.android.com/health-and-fitness/health-connect/migration/fit?hl=hi)
- [বাংলা](https://developer.android.com/health-and-fitness/health-connect/migration/fit?hl=bn)
- [ภาษาไทย](https://developer.android.com/health-and-fitness/health-connect/migration/fit?hl=th)
- [中文 – 简体](https://developer.android.com/health-and-fitness/health-connect/migration/fit?hl=zh-cn)
- [中文 – 繁體](https://developer.android.com/health-and-fitness/health-connect/migration/fit?hl=zh-tw)
- [日本語](https://developer.android.com/health-and-fitness/health-connect/migration/fit?hl=ja)
- [한국어](https://developer.android.com/health-and-fitness/health-connect/migration/fit?hl=ko)

[Android Studio](https://developer.android.com/studio)

[Sign in](https://developer.android.com/_d/signin?continue=https%3A%2F%2Fdeveloper.android.com%2Fhealth-and-fitness%2Fhealth-connect%2Fmigration%2Ffit&prompt=select_account)

- [Health & fitness dev center](https://developer.android.com/health-and-fitness)

- On this page
- [Recommended migration paths](https://developer.android.com/health-and-fitness/health-connect/migration/fit#recommended-paths)
  - [By application type](https://developer.android.com/health-and-fitness/health-connect/migration/fit#by-app-type)
  - [By current integration](https://developer.android.com/health-and-fitness/health-connect/migration/fit#by-integration)
- [Technical comparisons](https://developer.android.com/health-and-fitness/health-connect/migration/fit#technical-comparisons)
  - [Fit API versus Google Health API](https://developer.android.com/health-and-fitness/health-connect/migration/fit#fit-versus-gh-api)
  - [Fit API versus Health Connect](https://developer.android.com/health-and-fitness/health-connect/migration/fit#fit-versus-hc)
- [Fit API integrations](https://developer.android.com/health-and-fitness/health-connect/migration/fit#fit-api-integrations)
  - [Apps using the Fit Recording API for recording steps](https://developer.android.com/health-and-fitness/health-connect/migration/fit#recording-steps)
  - [Apps using the History API to read or write data to the fitness store](https://developer.android.com/health-and-fitness/health-connect/migration/fit#history-api)
  - [Apps using the Sensor API to display real-time fitness data](https://developer.android.com/health-and-fitness/health-connect/migration/fit#sensor-api)
  - [Apps using the Session API to provide activity summaries](https://developer.android.com/health-and-fitness/health-connect/migration/fit#session-api)
  - [Apps using the Goals API](https://developer.android.com/health-and-fitness/health-connect/migration/fit#goals-api)
  - [Apps using the BLE API](https://developer.android.com/health-and-fitness/health-connect/migration/fit#ble-api)
  - [Deprecated features](https://developer.android.com/health-and-fitness/health-connect/migration/fit#deprecated-features)
- [Fit app integrations](https://developer.android.com/health-and-fitness/health-connect/migration/fit#fit-app-integrations)
  - [Existing users of your app](https://developer.android.com/health-and-fitness/health-connect/migration/fit#existing-users)
  - [New users of your app](https://developer.android.com/health-and-fitness/health-connect/migration/fit#new-users)
...
| --- | --- |
| **Phone** | **Wear** |
| 1. To show a total step count,<br>    [add Health Connect to your app](https://developer.android.com/health-and-fitness/guides/health-connect/develop/get-started). The total includes<br>    [mobile steps](https://developer.android.com/health-and-fitness/guides/health-connect/develop/steps#read-mobile-steps) (Android 14 or higher) and steps from other apps and<br>    devices.<br>    <br>2. To continue showing local steps data in your app, implement writing data<br>    using<br>    [Health Connect's write API](https://developer.android.com/health-and-fitness/guides/health-connect/develop/write-data). | Use Health Services:<br>- PassiveMonitoringClient<br>- ExerciseClient<br>See the [Health Services documentation](https://developer.android.com/training/wearables/health-services) for more on the differences between the two. |

_Table 1: Migration steps from Fit Recording API_
...
_Table 2: Migration steps from Fit History API_
...
| --- | --- |
| **Phone** | **Wear** |
| Use [Sensors](https://developer.android.com/develop/sensors-and-location/sensors/sensors_overview),<br>[Fused Location Provider API](https://developers.google.com/location-context/fused-location-provider) | Use [Health Services](https://developer.android.com/health-and-fitness/guides/health-services)<br>on Wear OS:<br>- `PassiveMonitoringClient`<br>- `MeasureClient`<br>- `ExerciseClient`<br>  Or use `SensorManager`, `FusedLocationProvider` |

_Table 3: Migration steps from Fit Sensor API_
...
| --- | --- |
| **Phone** | **Wear** |
| Start/stop: Not applicable. The application should track the state of ongoing<br>sessions internally.<br>Read/write:<br>[Transition to the Google Health API](https://developers.google.com/health). | Start/stop: Use Health Services (ExerciseClient)<br>Read/write: Use Health Connect with your mobile app.<br>_For specific workflows, we advise the following:_<br>- Inserting a session: Developers should use Health Connect with their<br>   mobile app and either insert an `ExerciseSessionRecord` or a<br>   `SleepSessionRecord` accordingly. |

_Table 4: Migration steps from Fit Session API_
...
_Table 5: Migration guidance for Fit Goals API_
...
_Table 6: Migration steps from Fit BLE API_
...
- **Sensor API**: Use the Android Sensors framework or the Fused Location
Provider API for real-time raw data.
- **Goals API**: No replacement API available. Manage goal tracking and daily
activity targets within your application logic.
- **Bluetooth Low Energy (BLE) API**: Use the Android Bluetooth APIs directly to
...
| --- | --- |
| check **Do this** | close **Don't do this** |
| Include Health Connect or the Google Health API in your app's [setup flow](https://developer.android.com/health-and-fitness/guides/health-connect/design/ui-guidelines#app-setup-flow). | Offer Fit as an app that users can connect to once Health Connect is<br> available. |

_Table 8: Recommendations for new users with Fit app integrations_
